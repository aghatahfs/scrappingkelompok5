...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List<String>> extractData() async {
    ...
    final response = await http.Client()
        .get(Uri.parse('https://detiklife.com/cerita-lucu-humor-pendek/'));
    ...
    if (response.statusCode == 200) {
      ...
      try {
        ...
        var responseString2 =
            document.getElementsByClassName('entry-content')[0].children[9];

        print(responseString2.text.trim());

        // Scraping the third article title
        var responseString3 =
            document.getElementsByClassName('entry-content')[0].children[15];
